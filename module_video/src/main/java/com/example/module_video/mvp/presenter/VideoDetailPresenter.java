...
public class VideoDetailPresenter extends BasePresenter<VideoDetailContract.Model, VideoDetailContract.View> {
    ...
    public void getVideoDetail(String itemId) {
        mModel.getDetail("api", "getPost", itemId, 1)
                ...
                .subscribe(new ErrorHandleSubscriber<VideoDetailWebEntity>(mErrorHandler) {
                    @Override
                    public void onNext(VideoDetailWebEntity mainEntity) {
                        mRootView.updateListUI(mainEntity.getDatas());
                    }
                });
    }
