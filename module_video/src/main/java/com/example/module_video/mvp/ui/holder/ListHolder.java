 ...
 * Description:
 */
public class ListHolder extends BaseHolder<VideoListEntity.DatasBean> {
    ...
    public ListHolder(View itemView, int itemCount,List<VideoListEntity.DatasBean> infos) {
        super(itemView);
    ...
    @Override
    public void setData(VideoListEntity.DatasBean data, int position) {
