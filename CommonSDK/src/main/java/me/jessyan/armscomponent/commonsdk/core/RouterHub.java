...
public interface RouterHub {
    ...
    String VIDEO = "/video";//电影组件
    String TEXT = "/text";//文本组件
    String AUDIO = "/audio";//声音组件
     ...
     * 电影分组
     */
    String VIDEO_LISTACTIVITY = VIDEO + "/ListActivity";
    String VIDEO_DETAILACTIVITY = VIDEO + "/DetailActivity";

    /**
     * 文本分组
     */
    String TEXT_DETAILACTIVITY = TEXT + "/DetailActivity";
    String TEXT_LISTACTIVITY = TEXT + "/ListActivity";

    /**
     * 声音分组
     */
    String AUDIO_LISTACTIVITY = AUDIO + "/ListActivity";
    String AUDIO_DETAILACTIVITY = AUDIO + "/DetailActivity";
}
