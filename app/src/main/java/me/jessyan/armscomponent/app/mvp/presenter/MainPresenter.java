...
public class MainPresenter extends BasePresenter<MainContract.Model, MainContract.View> {
    ...
    public void getTextDetail(int page, int model, String pageId, String deviceId, String createTime) {
        mModel.getMain("api", "getList", page, model, pageId, createTime, "android", "1.3.0", TimeUtil.getCurrentSeconds(), deviceId, 1)
                ...
                .subscribe(new ErrorHandleSubscriber<MainEntity>(mErrorHandler) {
                    @Override
                    public void onNext(MainEntity mainEntity) {
                        int size = mainEntity.getDatas().size();
                        if (size > 0) {
