...
public class MainModel extends BaseModel implements MainContract.Model {
    ...
    @Override
    public Observable<MainEntity> getMain(String api, String getList, int page, int model, String pageId, String createTime, String android, String version, long time, String deviceId, int show_sdv) {
        return mRepositoryManager.obtainRetrofitService(MainService.class)
                .getList(api, getList, page, model, pageId, createTime, android, version, time, deviceId, show_sdv);
    }
}